...
// bot attack mask
#define	MASK_BOT_ATTACK_LEAD		(CONTENTS_SOLID)
#define	MASK_BOT_ATTACK_NONLEAD		(CONTENTS_SOLID|CONTENTS_WINDOW|CONTENTS_TRANSLUCENT|CONTENTS_ALPHA)
#define	MASK_BOT_ATTACK_SOLID_AUX	(CONTENTS_SOLID|CONTENTS_WINDOW|CONTENTS_TRANSLUCENT|CONTENTS_ALPHA|CONTENTS_AUX) //CONTENTS_LADDER?
...
//hypov8 team icons. overwrite stat cash
#define STAT_TEAMMATE_CASH		23
#define STAT_TEAM1_ICON			24
#define STAT_TEAM2_ICON			25
...
#define STAT_GUN_TIMER	 23 //STAT_POSITION	 //was  21
//#define		 22 //STAT_PLAYERS
// END
